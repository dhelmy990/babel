...
end after crossing midnight. Both are fixed, including recovery from incomplete
successful note responses. The combined affected suite passed 174 tests; final
