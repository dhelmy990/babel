...
from babel_benchmark.analysis import analyze, render_markdown
from babel_benchmark.contracts import ConditionTelemetryV1, RequestMeasurementV1
...
def measurement(condition: str, total: int, *, outcome: str = "success"):
    ...
    return RequestMeasurementV1(
        ...
        modelId=UUID("00000000-0000-5000-8000-000000000002") if server is not None else None,
...
def test_report_contains_latency_throughput_errors_and_slowdown() -> None:
    rows = [
        ...
        measurement("pgvector_training_no_sync", value) for value in (200, 400, 600, 800)
